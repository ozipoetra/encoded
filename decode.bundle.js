  ...
  var _0xaff7f4 = {
    ...
    0x3bb: (_0x288a64, _0x4dd75e, _0x1fdace) => {
      ...
      _0x288a64.exports = async (_0x15f8c3 = null, _0x17d9d4 = {}) => {
        try {
          var _0x320bc6 = await fetch(_0x15f8c3, _0x17d9d4);
        } catch ({
          message: _0x3ba244
        }) {
          _0x449854(_0x3ba244);
    ...
    0x2c: (_0xc12fe5, _0x57b100, _0x5b5c41) => {
      ...
      _0xc12fe5.exports = function (_0x4ca054 = "player") {
        ...
        this.setup = async (_0x5b7219 = {}) => {
          ...
          if (_0x537f4.preview) {
            var _0x2271a2 = _0xbe690("https://cdn.freeimagecdn.net/" + _0x1684eb, _0xe91a74);
            if (_0x2271a2) {
              if (!_0x537f4.tracks) {
                _0x537f4.tracks = [];
              }
        ...
        this.setup = async (_0x550c19 = 0x0) => {
          ...
          for (const _0x39ccdc in _0x3b187a) {
            ...
            if (_0x39ca4b) {
              ...
              _0x1bc07c.file = '//' + _0x392e97 + '/' + _0x1c9814 + '/' + _0x1786b1;
            } else if (_0x141df3) {
